...
class DuelingLinearDeepQNetwork(nn.Module):
    def __init__(self, ALPHA, n_actions, name, input_dims, chkpt_dir='/Users/44747/Reinforcement_Learning/DDQN'):
...
class Agent(object):
    def __init__(self, gamma, epsilon, alpha, n_actions, input_dims,
                 ...
                 replace=1000, chkpt_dir='/Users/44747/Reinforcement_Learning/DDQN'):
        self.gamma = gamma
